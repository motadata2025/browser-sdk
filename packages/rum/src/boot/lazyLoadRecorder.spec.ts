import { type DeflateWorker, type RawTelemetryEvent, type Telemetry, display } from '@motadata365/browser-core'
import type { RecorderApi, RumSessionManager } from '@motadata365/browser-rum-core'
import { LifeCycle } from '@motadata365/browser-rum-core'
import type { MockTelemetry } from '@motadata365/browser-core/test'
import { registerCleanupTask, startMockTelemetry, wait } from '@motadata365/browser-core/test'
