import type { TimeStamp, HttpRequest, HttpRequestEvent, Telemetry } from '@motadata365/browser-core'
import { PageExitReason, DefaultPrivacyLevel, noop, DeflateEncoderStreamId, Observable } from '@motadata365/browser-core'
import type { ViewCreatedEvent } from '@motadata365/browser-rum-core'
import { LifeCycle, LifeCycleEventType, startViewHistory } from '@motadata365/browser-rum-core'
import { collectAsyncCalls, createNewEvent, mockEventBridge, registerCleanupTask } from '@motadata365/browser-core/test'
