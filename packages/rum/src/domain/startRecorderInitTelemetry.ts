import type { Context, Duration, Telemetry, Observable, TimeStamp } from '@motadata365/browser-core'
import { TelemetryMetrics, addTelemetryMetrics, noop, timeStampNow, elapsed } from '@motadata365/browser-core'
