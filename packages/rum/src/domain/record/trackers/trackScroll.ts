import { DOM_EVENT, throttle, addEventListener } from '@motadata365/browser-core'
import type { RumConfiguration } from '@motadata365/browser-rum-core'
import { getScrollX, getScrollY, getNodePrivacyLevel, NodePrivacyLevel } from '@motadata365/browser-rum-core'
