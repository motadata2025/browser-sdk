import { throttle, DOM_EVENT, addEventListeners, timeStampNow, noop } from '@motadata365/browser-core'
import type { RumConfiguration, ViewportDimension } from '@motadata365/browser-rum-core'
import { initViewportObservable } from '@motadata365/browser-rum-core'
