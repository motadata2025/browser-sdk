import { instrumentSetter, DOM_EVENT, addEventListeners, noop } from '@motadata365/browser-core'
import { NodePrivacyLevel, getNodePrivacyLevel, shouldMaskNode } from '@motadata365/browser-rum-core'
