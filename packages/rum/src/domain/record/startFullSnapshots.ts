import { LifeCycleEventType, getScrollX, getScrollY, getViewportDimension } from '@motadata365/browser-rum-core'
import type { RumConfiguration, LifeCycle } from '@motadata365/browser-rum-core'
