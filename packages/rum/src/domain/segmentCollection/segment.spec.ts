import type { DeflateEncoder, TimeStamp, Uint8ArrayBuffer } from '@motadata365/browser-core'
import { noop, setDebugMode, DeflateEncoderStreamId } from '@motadata365/browser-core'
