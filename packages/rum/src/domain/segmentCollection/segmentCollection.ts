import type { DeflateEncoder, HttpRequest, TimeoutId } from '@motadata365/browser-core'
import { isPageExitReason, ONE_SECOND, clearTimeout, setTimeout } from '@motadata365/browser-core'
import type { LifeCycle, ViewHistory, RumSessionManager, RumConfiguration } from '@motadata365/browser-rum-core'
