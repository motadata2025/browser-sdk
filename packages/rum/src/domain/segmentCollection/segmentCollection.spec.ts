import type { ClocksState, HttpRequest, HttpRequestEvent, TimeStamp } from '@motadata365/browser-core'
import { DeflateEncoderStreamId, Observable, PageExitReason } from '@motadata365/browser-core'
import type { ViewHistory, ViewHistoryEntry, RumConfiguration } from '@motadata365/browser-rum-core'
...
import { mockClock, registerCleanupTask, restorePageVisibility } from '@motadata365/browser-core/test'
