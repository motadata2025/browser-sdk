import { callbackAddsInstrumentation, type Clock, mockClock, mockEventBridge } from '@motadata365/browser-core/test'
import type { TimeStamp, TrackingConsentState } from '@motadata365/browser-core'
import {
  ONE_SECOND,
  TrackingConsent,
