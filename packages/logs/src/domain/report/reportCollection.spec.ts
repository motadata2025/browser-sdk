import { ErrorHandling, ErrorSource, noop } from '@motadata365/browser-core'
import type { MockReportingObserver } from '@motadata365/browser-core/test'
import { mockReportingObserver } from '@motadata365/browser-core/test'
