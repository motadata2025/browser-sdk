import type { Context, ClocksState } from '@motadata365/browser-core'
import { timeStampNow, ErrorSource, getFileFromStackTraceString, initReportObservable } from '@motadata365/browser-core'
