import type { RelativeTime, DeflateWorker, TimeStamp } from '@motadata365/browser-core'
import { ONE_SECOND, display, DefaultPrivacyLevel, timeStampToClocks } from '@motadata365/browser-core'
