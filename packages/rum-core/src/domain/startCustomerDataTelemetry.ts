import type { Context, FlushEvent, Observable, Telemetry } from '@motadata365/browser-core'
import { ONE_SECOND, addTelemetryMetrics, setInterval, TelemetryMetrics } from '@motadata365/browser-core'
