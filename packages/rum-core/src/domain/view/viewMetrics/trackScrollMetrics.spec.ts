import type { RelativeTime, Subscription, TimeStamp } from '@motadata365/browser-core'
import { DOM_EVENT, Observable } from '@motadata365/browser-core'
import type { Clock } from '@motadata365/browser-core/test'
import { createNewEvent, mockClock, registerCleanupTask } from '@motadata365/browser-core/test'
