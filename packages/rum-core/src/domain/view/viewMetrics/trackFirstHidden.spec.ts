import type { RelativeTime, TimeStamp } from '@motadata365/browser-core'
import { clocksOrigin, DOM_EVENT } from '@motadata365/browser-core'
import { createNewEvent, restorePageVisibility, setPageVisibility } from '@motadata365/browser-core/test'
