import type { FlushEvent, Context, Telemetry } from '@motadata365/browser-core'
import { Observable, resetExperimentalFeatures } from '@motadata365/browser-core'
import type { Clock, MockTelemetry } from '@motadata365/browser-core/test'
import { mockClock, startMockTelemetry } from '@motadata365/browser-core/test'
