...
export const DEV_LOGS_URL = `${DEV_SERVER_ORIGIN}/motadata-logs.js`
export const DEV_RUM_SLIM_URL = `${DEV_SERVER_ORIGIN}/motadata-rum-slim.js`
export const DEV_RUM_URL = `${DEV_SERVER_ORIGIN}/motadata-rum.js`
